...
var setAttributeElValue = curry(function _setAttribute(attr, el, x){console.log(el);el[attr] = x;return x;});
var setAttributeValueEl = curry(function _setAttribute(attr, x, el){console.log(el);el[attr] = x;return el;});
